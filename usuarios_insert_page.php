...
$query = mysqli_query($conexion, $request02);
    ...
    <div class="row" style="--bs-gutter-x: 0.6rem;">
        ...
        <div class="col-sm-10">
            ...
            <div class="col-md-7 col-lg-8">
                <h4 class="mb-3">Insertar Nuevo Usuario</h4>
                <hr>
                <br>
                <form class="needs-validation" action="usuarios_insert.php" method="POST"> 
                    <div class="row g-3">
                        <div class="col-sm-6">
                        ...
                        <button class="w-100 btn btn-secondary btn-lg" type="submit">Agregar</button>
